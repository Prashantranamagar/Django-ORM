...
def practice_orm():
    ...
    # user1 = User.objects.create(username="Gholu", email="gholu@gmail.com")
    # user2 = User.objects.create(username="polu", email="polu@gmail.com")
    # q = Author.objects.get(pk=1).followers.add(user2, user1)  
    ...
    # q = Author.objects.get(id=3).followers.set(user) 
    #  This query uses the set() method to set the followers for an author. The get() method is used to retrieve the author with the specified primary key.



    # Query 20: Remove a follower from an author
    # user = User.objects.create(username="Ramukaka", email="ramukaka@gmail.com")
    # q = Author.objects.get(id=1).followers.add(user)
    # q = Author.objects.get(id=1).followers.remove(user)
